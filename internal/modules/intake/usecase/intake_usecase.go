...
import (
	...
	"github.com/arttVinci/fixora-Backend/internal/modules/intake/model"
...
func (i *IntakeUseCase) AnalyzeIssueImage(ctx context.Context, image *multipart.FileHeader) (*model.IssueAnalysisResultResponse, error) {
	file, err := image.Open()
	if err != nil {
...
func (i *IntakeUseCase) AnalyzeImage(ctx context.Context, image []byte, extension string) (*model.IssueAnalysisResultResponse, error) {
